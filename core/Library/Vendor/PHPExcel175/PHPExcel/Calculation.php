...
;
 ...
 // function __clone()
     ...
     *
     * @access public
     * @return string translation of TRUE
     */
     ...
     *
     * @access public
     * @return string translation of FALSE
     */
 ...
 // function calculate()
     ...
     *            whether the debug log should be reset or not
     * @return mixed
     * @throws Exception
     */
 ...
 // function calculateFormula()
     ...
     * @param string $cellID
     *            (e.g. A3) of the cell that we are calculating
     * @param PHPExcel_Cell $pCell
     *            calculate
     * @return mixed
     * @throws Exception
 ...
 // function _calculateFormulaValue()
     ...
     *            whether the matrices should be resized to match
 ...
 // function _checkMatrixOperands()
     ...
     * @return array array comprising the number of rows, and number of columns
     */
...
;
        ...
        while (true) {
            ...
            if ($opCharacter == '-' && ! $expectingOperator) { // Is it a negation instead of a minus?
                ...
                while ($stack->count() > 0 && ($o2 = $stack->last()) && isset(self::$_operators[$o2['value']]) && @($operatorAssociativity[$opCharacter] ? $operatorPrecedence[$opCharacter] < $operatorPrecedence[$o2['value']] : $operatorPrecedence[$opCharacter] <= $operatorPrecedence[$o2['value']])) {
 ...
 // function _raiseFormulaError()
     ...
     * @return mixed of values in range if range contains more than one element. Otherwise, a single value is returned.
     * @throws Exception
     */
