    ...
    private function _readXf()
    {
        ...
        if (! $this->_readDataOnly) {
            ...
            if ($this->_version == self::XLS_BIFF8) {
                ...
                $objStyle->getBorders()
                    ->getBottom()
                    ->setBorderStyle(self::_mapBorderStyle((0x01C00000 & $borderAndBackground) >> 22));
                ...
                $objStyle->getBorders()
                    ->getTop()
                    ->setBorderStyle(self::_mapBorderStyle((0x00000007 & $borderLines) >> 0));
                
                // bit: 5-3; mask: 0x00000038; left line style
                $objStyle->getBorders()
                    ->getLeft()
                    ->setBorderStyle(self::_mapBorderStyle((0x00000038 & $borderLines) >> 3));
                
                // bit: 8-6; mask: 0x000001C0; right line style
                $objStyle->getBorders()
                    ->getRight()
                    ->setBorderStyle(self::_mapBorderStyle((0x000001C0 & $borderLines) >> 6));
                ...
                switch ($extType) {
                    ...
                    case 7: // border color top
                        ...
                        if ($xclfType == 2) {
                            ...
                            // modify the relevant style property
                            if (isset($this->_mapCellXfIndex[$ixfe])) {
                                $top = $this->_phpExcel->getCellXfByIndex($this->_mapCellXfIndex[$ixfe])
                                    ->getBorders()
                                    ->getTop();
                    ...
                    case 8: // border color bottom
                        ...
                        if ($xclfType == 2) {
                            ...
                            // modify the relevant style property
                            if (isset($this->_mapCellXfIndex[$ixfe])) {
                                $bottom = $this->_phpExcel->getCellXfByIndex($this->_mapCellXfIndex[$ixfe])
                                    ->getBorders()
                                    ->getBottom();
                    ...
                    case 9: // border color left
                        ...
                        if ($xclfType == 2) {
                            ...
                            // modify the relevant style property
                            if (isset($this->_mapCellXfIndex[$ixfe])) {
                                $left = $this->_phpExcel->getCellXfByIndex($this->_mapCellXfIndex[$ixfe])
                                    ->getBorders()
                                    ->getLeft();
                    ...
                    case 10: // border color right
                        ...
                        if ($xclfType == 2) {
                            ...
                            // modify the relevant style property
                            if (isset($this->_mapCellXfIndex[$ixfe])) {
                                $right = $this->_phpExcel->getCellXfByIndex($this->_mapCellXfIndex[$ixfe])
                                    ->getBorders()
                                    ->getRight();
                    ...
                    case 11: // border color diagonal
                        ...
                        if ($xclfType == 2) {
                            ...
                            // modify the relevant style property
                            if (isset($this->_mapCellXfIndex[$ixfe])) {
                                $diagonal = $this->_phpExcel->getCellXfByIndex($this->_mapCellXfIndex[$ixfe])
                                    ->getBorders()
                                    ->getDiagonal();
    ...
    private function _readHyperLink()
    {
        ...
        if (! $this->_readDataOnly) {
            ...
            foreach (PHPExcel_Cell::extractAllCellReferencesInRange($cellRange) as $coordinate) {
                $this->_phpSheet->getCell($coordinate)
                    ->getHyperLink()
                    ->setUrl($url);
            }
        }
