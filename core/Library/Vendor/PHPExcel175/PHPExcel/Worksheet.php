...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
 ...
 // function getCellCacheController()
                ...
                if (isset($autoSizes[$cell->getColumn()])) {
                    ...
                    if (! isset($isMergeCell[$cell->getCoordinate()])) {
                        ...
                        $autoSizes[$cell->getColumn()] = max((float) $autoSizes[$cell->getColumn()], (float) PHPExcel_Shared_Font::calculateColumnWidth($this->getParent()
                            ...
                            ->getCellXfByIndex($cell->getXfIndex())
                            ->getAlignment()
                            ->getTextRotation(), $this->getDefaultStyle()->getFont()));
                    }
                }
            }
     ...
     *            worksheet (false, default) or the cell (true)
     * @return PHPExcel_Worksheet|PHPExcel_Cell on the last parameter being specified
     */
     ...
     *            the cell
     * @throws Exception
     * @return PHPExcel_Cell that was found
     */
     ...
     *            (e.g. A1)
     * @param int $pBreak
     *            (type of PHPExcel_Worksheet::BREAK_*)
     * @throws Exception
     * @return PHPExcel_Worksheet
     */
     ...
     *
     * @param int $pColumn1
     *            column coordinate of the first cell
     * @param int $pRow1
     *            row coordinate of the first cell
     * @param int $pColumn2
     *            column coordinate of the last cell
     * @param int $pRow2
     *            row coordinate of the last cell
     * @throws Exception
     * @return PHPExcel_Worksheet
     */
     ...
     *
     * @param string $pRange
     *            A1) or cell range (e.g. A1:E1)
     * @param string $pPassword
     *            unlock the protection
     * @param boolean $pAlreadyHashed
     *            password has already been hashed, set this to true
     * @throws Exception
     * @return PHPExcel_Worksheet
     */
     ...
     *            coordinate of the first cell
     * @param int $pColumn2
     *            coordinate of the last cell
     * @param int $pRow2
     *            coordinate of the last cell
     * @param string $pPassword
     *            unlock the protection
     * @param boolean $pAlreadyHashed
     *            the password has already been hashed, set this to true
     * @throws Exception
     * @return PHPExcel_Worksheet
     */
     ...
     *
     * @param int $pBefore
     *            this one (numeric column coordinate of the cell)
     * @param int $pNumCols
     *            columns to insert
     * @throws Exception
     * @return PHPExcel_Worksheet
     ...
     *
     * @param int $pColumn
     *            with this one (numeric column coordinate of the cell)
     * @param int $pNumCols
     *            columns to remove
     * @throws Exception
     * @return PHPExcel_Worksheet
     ...
     *            source array that stands for blank cell
     * @param string $startCell
     *            starting from this cell address as the top left coordinate
     * @param boolean $strictNullComparison
     *            comparison when testing for null values in the array
     * @throws Exception
     * @return PHPExcel_Worksheet
     */
     ...
     *            Return a simple array of rows and columns indexed by number counting from zero
     ...
     *
     * @param string $pCellCoordinate
     *            coordinate to get hyperlink for
     */
     ...
     *
     * @param string $pCellCoordinate
     *            coordinate to insert hyperlink
     ...
     *
     * @param string $pCellCoordinate
     *            coordinate to get data validation for
     */
     ...
     *
     * @param string $pCellCoordinate
     *            coordinate to insert data validation
