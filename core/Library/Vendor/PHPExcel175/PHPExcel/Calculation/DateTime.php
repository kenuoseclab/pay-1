...
class PHPExcel_Calculation_DateTime
{
 ...
 // function _dateDiff360()
     ...
     * @return mixed date/time serial value, or string if error
     */
 ...
 // function _adjustDateByMonths()
     ...
     * DATETIMENOW
     *
     * @return mixed date/time serial value, PHP date/time serial value or PHP date/time object,
 ...
 // function TIMEVALUE()
     ...
     *            serial value or a standard date string
     * @param long $endDate
     *            serial value or a standard date string
     * @param string $unit            
     * @return long between the dates
     */
 ...
 // function DAYS360()
     ...
     *            serial value (float), PHP date timestamp (integer) or date object, or a standard date string
     * @param mixed $endDate
     *            serial value (float), PHP date timestamp (integer) or date object, or a standard date string
 ...
 // function YEAR()
     ...
     *            serial value or a standard time string
     * @return int
     */
