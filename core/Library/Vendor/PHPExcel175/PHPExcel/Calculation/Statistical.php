...
class PHPExcel_Calculation_Statistical
{
 ...
 // function AVERAGE()
    ...
    public static function AVERAGEA()
    {
        ...
        // Loop through arguments
        foreach (PHPExcel_Calculation_Functions::flattenArrayIndexed(func_get_args()) as $k => $arg) {
            if ((is_bool($arg)) && (! PHPExcel_Calculation_Functions::isMatrixValue($k))) {} else {
 ...
 // function AVERAGEIF()
     ...
     *
     * @param float $value
     *            which you want to evaluate the distribution
     * @param float $alpha
     *            the distribution
     * @param float $beta
     *            the distribution
 ...
 // function KURT()
     ...
     * @param mixed $arg,...            
     * @param int $entry
     *            from the largest) in the array or range of data to return
     * @return float
     *
     */
 ...
 // function SLOPE()
     ...
     * @param mixed $arg,...            
     * @param int $entry
     *            from the smallest) in the array or range of data to return
     * @return float
     */
    ...
    public static function VARA()
    {
        ...
        foreach ($aArgs as $k => $arg) {
            if ((is_string($arg)) && (PHPExcel_Calculation_Functions::isValue($k))) {
                return PHPExcel_Calculation_Functions::VALUE();
            } elseif ((is_string($arg)) && (! PHPExcel_Calculation_Functions::isMatrixValue($k))) {} else {
                // Is it a numeric value?
                if ((is_numeric($arg)) || (is_bool($arg)) || ((is_string($arg) & ($arg != '')))) {
                    if (is_bool($arg)) {
                        $arg = (integer) $arg;
