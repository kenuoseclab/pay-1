...
class PHPExcel_Calculation_MathTrig
{
 ...
 // function _romanCut()
     ...
     *            of the point.
     * @return float inverse tangent of the specified x- and y-coordinates.
     */
 ...
 // function CEILING()
     ...
     *            different objects
     * @param int $numInSet
     *            objects in each combination
     * @return int of combinations
     */
 ...
 // function LCM()
     ...
     * @category Mathematical and Trigonometric Functions
     * @param float $value
     *            real number for which you want the logarithm
     * @param float $base
     *            of the logarithm. If base is omitted, it is assumed to be 10.
     * @return float
     */
 ...
 // function ROUNDDOWN()
     ...
     *            to the power series
     * @param float $n
     *            to which you want to raise $x
     * @param float $m
     *            which to increase $n for each term in the series
     * @param
     *            array of mixed Data Series
     * @return float
     */
 ...
 // function SIGN()
     ...
     *
     * @param float $number            
     * @return float Root of Number * Pi
     */
 ...
 // function SUM()
     ...
     *            that defines which cells will be summed.
     * @return float
     */
