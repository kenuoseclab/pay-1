...
class PHPExcel_Worksheet_PageSetup
{
     ...
     *
     * @param int $index
     *            a specific print area range if several ranges have been set
     ...
     * @param string $value            
     * @param int $index
     *            a specific print area range allowing several ranges to be set
     ...
     *            Print areas are numbered from 1
     * @param string $method
     *            method used when setting multiple print areas
