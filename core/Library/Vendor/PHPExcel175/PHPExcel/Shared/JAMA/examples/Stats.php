...
class Base
{
 /* {{{ */
    ...
    /**
     * Expanded data set.
     * Only set when cummulative data
 ...
 /* }}} */
     ...
     *            whether to return a expanded list, default is false
 ...
 /* }}} */
     ...
     * This will reset all pre-calculated
 ...
 /* }}} */
     ...
     * @access public
     * @param int $mode
     *            one of STATS_BASIC or STATS_FULL
     * @param boolean $returnErrorObject
     *            whether the raw PEAR_Error (when true, default),
 ...
 /* }}} */
    ...
    /**
     * Calculates the variance (unbiased) of the data points in the set
     * given a fixed mean (average) value.
     * Not used in calcBasic(), calcFull()
     * or calc().
     * Handles cummulative data sets correctly
     *
     * @access public
     * @param numeric $mean
     *            the fixed mean value
 ...
 /* }}} */
     ...
     * percentiles.
     * Basically the range of the middle 50% of the data set,
 ...
 /* }}} */
     ...
     * @access public
     * @param numeric $p
     *            the percentile to estimate, e.g. 25 for 25th percentile
     * @return mixed a numeric value on success, a PEAR_Error otherwise
     * @see quartiles()
     * @see median()
     */
 ...
 /* }}} */
     ...
     * @access private
     * @param $mean the
     *            fixed mean to use, null as default
     * @return mixed a numeric value on success, a PEAR_Error otherwise
     * @see variance()
     * @see varianceWithMean()
     */
