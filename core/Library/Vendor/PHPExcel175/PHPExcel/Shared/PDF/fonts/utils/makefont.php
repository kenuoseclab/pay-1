 ...
 *            path to font file (TTF, OTF or PFB).
 * @param string $fmfile
 *            font metrics file (UFM or AFM).
 * @param boolean $embedded
 *            Set to false to not embed the font, true otherwise (default).
 * @param string $enc
 *            Name of the encoding table to use. Omit this parameter for TrueType Unicode, OpenType Unicode and symbolic fonts like Symbol or ZapfDingBats.
 * @param array $patch
 *            Optional modification of the encoding
 */
 ...
 * 
 * @param string $enc
 *            map name (see /enc/ folder for valid names).
 */
