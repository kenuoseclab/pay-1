...
class PHPExcel_Writer_HTML implements PHPExcel_Writer_IWriter
{
     ...
     *            whether the sheet navigation block should be generated or not
     * @return PHPExcel_Writer_HTML
     */
    ...
    private function _createCSSStyle(PHPExcel_Style $pStyle)
    {
        ...
        // Create CSS
        $css = array_merge($this->_createCSSStyleAlignment($pStyle->getAlignment()), $this->_createCSSStyleBorders($pStyle->getBorders(), $pStyle->getFill()), $this->_createCSSStyleFont($pStyle->getFont()), $this->_createCSSStyleFill($pStyle->getFill()));
