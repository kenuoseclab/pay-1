...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     *
     * @param PHPExcel $pPHPExcel            
     * @return PHPExcel_Style[] styles in PHPExcel
     * @throws Exception
     */
     ...
     *
     * @param PHPExcel $pPHPExcel            
     * @return PHPExcel_Style_Conditional[] conditional styles in PHPExcel
     * @throws Exception
     */
     ...
     *
     * @param PHPExcel $pPHPExcel            
     * @return PHPExcel_Style_Fill[] fills in PHPExcel
     * @throws Exception
     */
     ...
     *
     * @param PHPExcel $pPHPExcel            
     * @return PHPExcel_Style_Font[] fonts in PHPExcel
     * @throws Exception
     */
     ...
     *
     * @param PHPExcel $pPHPExcel            
     * @return PHPExcel_Style_Borders[] borders in PHPExcel
     * @throws Exception
     */
     ...
     *
     * @param PHPExcel $pPHPExcel            
     * @return PHPExcel_Style_NumberFormat[] number formats in PHPExcel
     * @throws Exception
     */
