...
window.common = {
    ...
    toOrderList: function() {
        var merchantName = window.merchantName || window.sessionStorage.getItem('merchantName') || ''
        window.sessionStorage.setItem('merchantName', merchantName)
        window.location.href = "/merchant/matchcenter/tradeFast/v2/list?n="+merchantName;
    },
    /**
     * 首页（充值页）
     */
    toIndexMoney: function() {
        var merchantName = window.merchantName || window.sessionStorage.getItem('merchantName') || ''
        window.sessionStorage.setItem('merchantName', merchantName)
        window.location.href = "/merchant/matchcenter/tradeFast/v2/index?n="+merchantName;
    },
