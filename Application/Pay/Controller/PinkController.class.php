...
class PinkController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $tradeNo=$return['orderid'];   //订单号，需要保证唯一，不可重复提交相同订单ID
        ...
        $platform="xx";
        $payNotifyUrl=$return["notifyurl"];
        $bcMerchantPublicKey="GCNPSEFPRJNYVC5EZUGXWEQRBZMTEGXDZB2WVJ2FGIIZYJSSWYYAMEFU";
