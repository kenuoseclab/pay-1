...
<div class="tastesdk-box">
    ...
    <div class="main">
        <div class="typedemo">
            <div class="demo-pc">
                <div class="pay-jd">
                    <form action="YIBAO2.php" method="post" autocomplete="off">
...
<!--                                </li>-->
                                ...
                                <!--</li>-->
                                <li>
                                    <input value="911" name="channel" id="kjzf" type="radio">
                                    <label for="kjzf"><img src="yinlian.png" alt="快捷支付"><span>快捷支付</span></label>
                                </li>
                                <li>
                                    <input value="912" name="channel" id="ylwap" type="radio">
                                    <label for="ylwap"><img src="yinlian.png" alt="快捷支付"><span>银联H5</span></label>
                                </li>
<!--                               <li>-->
