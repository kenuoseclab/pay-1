...
<div class="tastesdk-box">
    ...
    <div class="main">
        <div class="typedemo">
            <div class="demo-pc">
                <div class="pay-jd">
                    <form action="sao8pay_2.php" method="post" autocomplete="off">
                        ...
                        <div class="two-step">
                            ...
                            <ul class="pay-infor">
                                ...
                                <li>支付金额：<strong><input type="number" name="amount" value="1"> <span>元</span></strong></li>
                                <li>订单编号：<span><?php echo $pay_orderid;?></span></li>
                            </ul>
                            <h5>选择支付方式：</h5>
                            <ul class="pay-label">
                                <li>
                                    <input value="904" name="channel" id="alipaywap" type="radio">
                                    <label for="alipaywap"><img src="zhifubao.png" alt="Alipay"><span>支付宝H5</span></label>
                                </li>
                                <li>
                                    <input value="903" name="channel" id="alipayscan" type="radio">
                                    <label for="alipayscan"><img src="zhifubao.png" alt="Alipay"><span>支付宝扫码</span></label>
                                </li>
								<li>
