...
$pay_notifyurl = "https://" . $_SERVER['HTTP_HOST'] . "/demo/server.php";   //服务端返回地址
$pay_callbackurl = "https://" . $_SERVER['HTTP_HOST'] . "/demo/page.php";  //页面跳转返回地址
$Md5key = "t4ig5acnpx4fet4zapshjacjd9o4bhbi";   //密钥
$tjurl = "https://" . $_SERVER['HTTP_HOST'] . "/Pay_Index.html";   //提交地址
